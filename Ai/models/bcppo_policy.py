...
SEED   = 1
RUN_ID = "BCPPO_s1"   # options: "BCPPO_s1"  |  "BCPPO_s2"
# ─────────────────────────────────────────────────────────────────────────────
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="BCPPO training (BC warm-start + masking)")
